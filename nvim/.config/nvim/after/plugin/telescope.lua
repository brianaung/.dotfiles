...
map("n", "<leader>en", "<cmd>lua require 'telescope.builtin'.find_files{ cwd='~/.config/nvim' }<cr>", opts)
map("n", "<leader>fc", "<cmd>lua require 'telescope.builtin'.current_buffer_fuzzy_find{}<cr>", opts)
map("n", "<leader>ft", "<cmd>lua require 'telescope.builtin'.git_files{}<cr>", opts)
